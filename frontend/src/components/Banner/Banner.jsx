                    ...
                    <div className=' flex-1 space-y-8 relative md:pr-8 lg:pr-10 text-center md:text-left'>
                        ...
                        <div className=' flex flex-wrap gap-4 justify-center md:justify-start mt-6'>
                            <button onClick={() => setShowVideo(true)} className=' group flex items-center gap-3 bg-gradient-to-r from-amber-400 to-amber-300
                             hover:from-amber-300 hover:to-amber-200 px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-amber-300/30'>
                    ...
                    <div className=' flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]'>
                        ...
                        {orbitImages.map((imgSrc, index) => (
                            <div key={index} className={` absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2
                                ...
                                className=' w-full h-full rounded-full border-amber-500/30 shadow-lg bg-amber-900/20 object-cover'/>
                            </div>
                        ))}
                    </div>
