...
import { FaArrowRight, FaCheckCircle, FaEye, FaEyeSlash, FaLock, FaRoad, FaUser, FaUserPlus } from 'react-icons/fa';
    ...
    <div className=' space-y-6 relative'>
      <div className={`fixed top-4 right-4 z-50 transition-all duration-300
        ${showToast ? 'translate-y-0 opacity-100' : '-translate-y-20 opacity-0'}`}>
          <div className=' bg-green-400 text-white px-4 py-3 rounded-md shadow-lg flex items-center gap-2 text-sm'>
      ...
      <form onSubmit={handleSubmit} className=' space-y-6'>
        ...
        <button className=' w-full py-3 bg-gradient-to-r from-amber-400 to-amber-600 text-[#2D1B0E] font-bold rounded-lg flex items-center
         justify-center gap-2 hover:scale-105 transition-transform'>
