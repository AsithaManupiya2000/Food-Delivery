            ...
            <div className=' flex justify-between items-center h-16 md:h-20 lg:h-24'>
                ...
                lg:-translate-x-6 ml-0 md:ml-2'>
                    ...
                    <GiChefToque className=' text-3xl md:text-4xl lg:text-5xl text-amber-500 transition-all group-hover:rotate-12
                     group-hover:text-amber-400 hover:drop-shadow-[0_0_15px] hover:drop-shadow-500/50' /> 

                    <div className=' flex flex-col relative ml-2 max-w-[140px] md:max-w-[160px] lg:max-w-none'>
                        <NavLink to='/' className=' text-2xl md:text-xl lg:text-4xl bg-gradient-to-r from-amber-400 to-amber-600
                         bg-clip-text text-transparent font-mosieur tracking-wider drop-shadow-[0_2px_2px] drop-shadow-black -translate-x-2
                ...
                <div className='hidden md:flex items-center space-x-2 md:space-x-1 lg:space-x-4 flex-1 justify-end'>
                    ...
                    <div className=' flex items-center space-x-2 md:space-x-3 lg:space-x-4
                     ml-3 md:ml-3 lg:ml-6 mr-2 md:mr-3 lg:mr4'>
                        <NavLink to='/cart' className='p-2 md:p-2 lg:p-3 text-amber-100 rounded-xl transition-all
                        relative border-2 border-amber-900/30 hover:border-e-amber-600/50 group hover:bg-amber-900/20
                ...
                <div className=' md:hidden flex items-center mr-2'>
                    <button className='text-amber-500 hover:text-amber-300 focus:outline-none transition-all p-2 rounded-xl border-2
                    border-amber-900/30 hover:border-amber-600/50 relative shadow-md shadow-amber-900/20 hover:shadow-lg hover:shadow-amber-900/30'
