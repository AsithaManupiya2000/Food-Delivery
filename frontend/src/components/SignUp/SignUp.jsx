...
const SignUp = () => {
  ...
  return (
    <div className=' min-h-screen flex items-center justify-center bg-[#1a120b] p-4'>
      {showToast && <AwesomeToast messasage="Sign Up Successful" icon={<FaCheckCircle/>} />}
     ...
     transform transition-all duration-300 hover:shadow-2xl'>
      ...
      <form onSubmit={handleSubmit} className=' space-y-4'>
        ...
        <input type='text' name='username' placeholder='Username' value={formData.username}
         ...
         className=' w-full px-4 py-3 rounded-lg bg-[#2D1B0E] text-amber-100 placeholder-amber-400 focus:outline-none focus:ring-2
         focus:ring-amber-600 transition-all duration-200 hover:scale-[1.02]' required/>
        ...
        <input type='email' name='email' placeholder='E-mail' value={formData.email}
         ...
         <button type='submit' className='w-full py-3 bg-gradient-to-r from-amber-400 to-amber-600 text-[#2D1B0E] font-bold rounded-lg
